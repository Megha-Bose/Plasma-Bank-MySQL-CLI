...
INSERT INTO `DEPARTMENT` VALUES ('DL','1234','list of vehicles in logistivs dept',1,NULL),('DPI','123','count of samples in each inventory in plasma inventories dept',1,'Good');
...
INSERT INTO `DONOR` VALUES ('1','test',1,'A+',1,18,'1990-01-01','DONOR1'),('2','test name',2,'A+',0,28,'1980-01-01','DONOR2');
...
INSERT INTO `HOSPITAL` VALUES ('1','Care',10.00,'HOSP1');
...
INSERT INTO `PLASMA` VALUES ('1','2020-02-02',1,0,'1');
...
INSERT INTO `PLASMA_INVENTORY` VALUES ('1',1,0,0,0,0,0,0,0,10,9,'DPI');
...
INSERT INTO `USER` VALUES ('123','abc',123456789,'hi,hello, bye'),('ADMIN','admin',123456789,'a_address'),('DONOR1','d1',123456789,'d_address1'),('DONOR2','d2',2,'d_address2'),('HOSP1','h1',123456789,'h_address1'),('HOSPITAL1','h1',123456789,'h_address1'),('STAFF1','s1',123456789,'s_address1'),('STAFF2','s2',123456789,'s_address2');
...
INSERT INTO `WORKS_FOR` VALUES ('DL','2'),('DPI','1');
...
-- Dump completed on 2020-10-06 15:32:27
